...
create_generated_clock -name tmds_clk        [get_pins video_out_clock_inst/MMCM/CLKOUT0]
create_generated_clock -name hdmi_clk        [get_pins video_out_clock_inst/MMCM/CLKOUT1]

## The following constraints are needed by video_out_clock.vhd
create_generated_clock -name div_clk -source [get_ports {clk_i}] -divide_by 2 [get_pins video_out_clock_inst/clki_div_reg/Q]
set_case_analysis 1 [get_pins video_out_clock_inst/clk_mux_reg/Q]

create_generated_clock -name Slow_Clock_25MHz -source [get_pins {clk_main/CLKOUT1}] -divide_by 2 [get_pins sd_card/Slow_Clock_25MHz_reg/Q]
